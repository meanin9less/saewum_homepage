    ...
    <div className="pt-48 min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          <div>
            <img src="/business-people-working.jpg" alt="ICL Lab" className="rounded-lg shadow-lg mb-6" />
            <img src="/keyboard-hands-typing.jpg" alt="Development" className="rounded-lg shadow-lg" />
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-blue-50 p-6 rounded-lg">
              <h3 className="text-xl font-bold mb-4 text-blue-800">열린 마음으로 소통하는 연구소</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div>
              <img src="/team-collaboration.png" alt="Team Work" className="rounded-lg shadow-lg" />
            </div>
