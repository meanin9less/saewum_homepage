  ...
  const useCaseScenarios = [
    {
      ...
      bullets: [
        "민원 처리에 필요한 정보를 자동으로 파악하고 즉시 응답",
        "각 부서별 업무 지침을 챗봇이 학습하여 정확한 안내 제공",
        "자주 묻는 질문을 데이터 기반으로 최적화하여 행정 부담을 경감",
      ],
    },
    {
      label: "기업",
      ...
      bullets: [
        "고객 문의에 대한 자동 응답과 상담 히스토리 일원화",
        "부서별 매뉴얼·정책 문서를 요약·배포",
        "영업, 인사, 재무 등 주요 시스템과 연동하여 지식 자산화를 지원",
      ],
    },
    {
      label: "병원 및 학원",
      ...
      bullets: [
        "진료 및 강의 예약 현황을 실시간으로 안내하고 변경 사항 자동 공지",
        "의료/교육 매뉴얼을 기반으로 정확한 상담 스크립트 제공",
        "학생·환자별 히스토리를 참고하여 맞춤형 다음 액션 추천",
      ],
    },
    {
      label: "로봇",
      ...
      bullets: [
        "음성·터치·센서 입력을 통합해 로봇이 즉각적인 안내 제공",
        "업무 시나리오별 로봇 응대 스크립트를 중앙에서 관리",
        "로봇 사용 로그를 분석하여 적절한 정보를 실시간 보완",
      ],
    },
    {
      label: "키오스크",
      ...
      bullets: [
        "상품 추천, 절차 안내 등 대화형 인터페이스를 키오스크에 탑재",
        "결제/주문 단계에 맞춰 필요한 서류나 안내문을 자동 노출",
        "사용 패턴을 분석해 화면 구성과 대화 흐름을 지속적으로 개선",
      ],
    },
    {
      label: "소상공인",
      ...
      bullets: [
        "SNS·채팅문의·전화 내용을 통합해 고객 응대를 자동화",
        "재고 상황, 영업 일정 등을 챗봇이 확인하여 맞춤 안내",
        "간단한 템플릿으로 프로모션 멘트를 수정하고 즉시 배포",
      ],
    },
  ]
