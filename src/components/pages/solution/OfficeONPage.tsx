  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="py-6 flex flex-col items-center justify-center max-w-2xl mx-auto">
        <img src="/img/solution/officeonLogoColor.png" alt="officeon" className="h-40 object-contain mb-2" />
        <p className="text-2xl font-bold text-blue-600">실시간 협업의 컨버젼스 그룹웨어</p>
      </div>

      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="flex flex-col items-center gap-8 mb-16">
          <img src="/img/solution/officeon_bg1.png" alt="officeon" className="w-full h-[28rem] object-contain rounded-lg shadow-lg" />
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="bg-white border rounded-lg p-6 hover:shadow-md transition-shadow text-center">
                <div className="w-30 h-30 rounded-lg flex items-center justify-center mb-4 mx-auto">
                  <img src={feature.image} alt={feature.title} className="w-40 h-40 object-contain" />
                </div>
                <h3 className="text-2xl font-bold mb-3 text-blue-700">{feature.title}</h3>
